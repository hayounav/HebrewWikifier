...
public class PageStep extends Configured implements Tool {
	...
	protected enum Output {tempPage, tempRedirect, tempRootCategory, tempEditDates} ;
	protected enum Counter {articleCount, categoryCount, disambiguationCount, redirectCount, rootCategoryId, rootCategoryCount} ;
